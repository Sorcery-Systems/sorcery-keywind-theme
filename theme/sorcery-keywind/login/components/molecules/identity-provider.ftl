...
<#macro kw providers=[]>
  <div class="pt-4 separate text-secondary text-sm">
    ...
    <#list providers as provider>
      <#switch provider.alias>
        ...
        <#case "twitter">
          ...
          <#break>
        <#default>
          <#assign colorClass="hover:bg-secondaryVeryLight">
      </#switch>

      <a
        class="${colorClass} border border-secondaryVeryLight flex justify-center py-2 rounded-lg hover:border-transparent"
